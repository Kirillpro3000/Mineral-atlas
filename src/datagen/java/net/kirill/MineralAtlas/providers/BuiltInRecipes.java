...
public class BuiltInRecipes extends EnhancedRecipeProvider {
	...
	protected void buildRecipes(final RecipeOutput recipeOutput, final Provider holderLookup) {
		CraftingRecipeBuilder.shaped(MineralAtlasModItems.EXAMPLE_ITEM, 11)
		...
		AdvancedCraftingRecipeBuilder.shapeless("example_recipe_folder", ItemStackProvider.of(MineralAtlasModItems.EXAMPLE_ITEM))
				...
				.save(recipeOutput, MineralAtlas.location("custom_recipe_name"));

		AdvancedCraftingRecipeBuilder.shaped(MineralAtlasModItems.EXAMPLE_ITEM, 1)
				.pattern("s")
				.pattern("S")
		...
		AnvilRecipeBuilder.welding(MineralAtlasModItems.EXAMPLE_ITEM, 15)
		...
		KnappingRecipeBuilder.leather(MineralAtlasModItems.EXAMPLE_ITEM.toStack(5))
				.pattern("X    ", " X   ", "  X  ", "   X ", "    X")
				.save(recipeOutput);
	}
}