...
public class BuiltInItemModels extends ItemModelProvider {
	...
	public BuiltInItemModels(final PackOutput packOutput, final ExistingFileHelper existingFileHelper) {
		super(packOutput, MineralAtlas.MOD_ID, existingFileHelper);
	}
	...
	protected void registerModels() {
		...
		getBuilder(MineralAtlasModItems.EXAMPLE_ITEM).parent(ITEM_GENERATED).texture("layer0", mcLoc("block/debug"));
	}
